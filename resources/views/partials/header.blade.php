    ...
    <div class="max-w-7xl mx-auto flex items-center justify-between px-3 sm:px-6 py-3 sm:py-3.5 gap-2 sm:gap-4">
        ...
        <div class="flex items-center gap-1 sm:gap-2 shrink-0">
            ...
            <button @click="mobileSearchOpen = !mobileSearchOpen; mobileMenuOpen = false"
                class="sm:hidden w-9 h-9 flex items-center justify-center text-gray-600 hover:text-navy rounded-full hover:bg-gray-100 transition-colors"
                aria-label="Buscar">
            ...
            <button @click="mobileMenuOpen = !mobileMenuOpen; mobileSearchOpen = false"
                class="sm:hidden w-9 h-9 flex items-center justify-center text-navy rounded-xl hover:bg-gray-100 transition-colors"
            ...
            <div class="flex items-center gap-1 lg:gap-2 text-sm text-white/80 font-medium">
                ...
                <div class="relative" x-data="{ open: false }" @click.outside="open = false">
                    <button @click="open = !open"
                        class="relative py-3.5 px-3.5 transition-colors duration-200 hover:text-white flex items-center gap-1.5 group {{ request()->routeIs('home.acerca', 'sedes.index') ? 'text-white font-semibold' : '' }}">
                        <span>Acerca de</span>
