...
<div class=" bg-gray-50/50 py-10 px-4 sm:px-6 lg:px-8" 
    ...
    <div class="max-w-7xl mx-auto space-y-6">
        ...
        <div class="flex items-center justify-between">
            ...
            {{-- Badge de Estado --}}
            <span class="inline-block text-xs font-bold border rounded-full px-3.5 py-1 shadow-sm bg-white {{ $convocatoria->estado_inscripcion['badge'] }}">
            ...
            <div class="lg:col-span-4 space-y-6 lg:sticky lg:top-8">
                ...
                <div class="bg-white rounded-3xl p-4 border border-gray-100 shadow-sm space-y-4">
                    ...
                    <div @click="lightboxOpen = true" 
                        ...
                        <img src="{{ $convocatoria->url_imagen }}" 
                             alt="{{ $convocatoria->nombre }}" 
                             class="w-full h-auto object-cover transition-transform duration-300 group-hover:scale-105">
                        
                        {{-- Hover Overlay --}}
                        <div class="absolute inset-0 bg-navy/40 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center text-white font-bold text-xs gap-2 backdrop-blur-xs">
            ...
            <div class="lg:col-span-8 bg-white rounded-3xl p-6 sm:p-10 border border-gray-100 shadow-sm space-y-8">
                ...
                <div class="space-y-3 pb-6 border-b border-gray-100">
                    ...
                    <p class="text-xs text-gray-400">
                        Publicado el {{ $convocatoria->created_at?->locale('es')->translatedFormat('j \d\e F \d\e Y') ?? 'recientemente' }}
                    </p>
                </div>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 bg-gray-50 p-5 rounded-2xl border border-gray-100">
                    ...
                    <div class="flex items-start gap-3">
                        ...
                        <div>
                            ...
                            <span class="text-sm font-bold text-navy">{{ $convocatoria->fecha_registro_formateada }}</span>
                        </div>
                    </div>
                </div>
