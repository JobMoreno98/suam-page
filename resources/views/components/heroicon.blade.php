...
@switch($name)
    ...
    @case('agricultura')
        <svg class="{{ $class }}" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round"
                d="M12 18v-5.25m0 0a6.01 6.01 0 001.5-.189m-1.5.189a6.01 6.01 0 01-1.5-.189m3.75 7.478a12.06 12.06 0 01-4.5 0m3.75 2.383a14.406 14.406 0 01-3 0M14.25 18v-1.875c0-.621.504-1.125 1.125-1.125h1.5a3.375 3.375 0 003.375-3.375V11.25M3.75 11.25v.375a3.375 3.375 0 003.375 3.375h1.5c.621 0 1.125.504 1.125 1.125V18" />
        </svg>
    @break
